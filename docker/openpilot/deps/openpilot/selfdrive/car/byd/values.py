...
HUD_MULTIPLIER = 0.718 # was 0.718, should be 0.745, Ting calculated it in June 2025

class CAR:
  ATTO3 = "BYD ATTO 3"

class BydCarInfo(CarInfo):
  package: str = "BYD Car Assist"

CAR_INFO: Dict[str, Optional[Union[BydCarInfo, List[BydCarInfo]]]] = {
  CAR.ATTO3: BydCarInfo("BYD ATTO 3", "All")
}
