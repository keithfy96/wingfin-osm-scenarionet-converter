...
void update_leads(UIState *s, const cereal::RadarState::Reader &radar_state, const cereal::XYZTData::Reader &line) {
  for (int i = 0; i < 2; ++i) {
    ...
    // [pimpke] TODO: check if lead status is false here
...
void update_model(UIState *s, 
  ...
  // [pimpke] TODO: plan should be of size TRAJECTORY_SIZE 
  ...
  // update lane lines
  // [pimpke] TODO: test if lane lines are OK to be of size 0
  ...
  // update road edges
  // [pimpke] TODO: test if road edges are OK to be of size 0
  ...
  int max_idx = get_path_length_idx(plan_position, max_distance);
