...
procs = [
  ...
  NativeProcess("boardd", "selfdrive/boardd", ["./boardd"], enabled=False, offroad=True),  # no offroad param in merge-base
  ...
  PythonProcess("plannerd", "selfdrive.controls.plannerd", offroad=True),  # no offroad param in merge-base
