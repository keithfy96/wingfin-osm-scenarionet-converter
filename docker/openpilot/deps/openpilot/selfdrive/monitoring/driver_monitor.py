...
class DriverStatus():
  ...
  def set_policy(self, model_data, car_speed):
    # [pimpke] TODO: seems this is the only place where modelV2 is used in dmonitoringd, should we turn off driver_status policy?
    # [pimpke] TODO: is it easy to turn off the whole dmonitoringd process?
