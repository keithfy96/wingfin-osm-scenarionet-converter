...
class RadarD():
  ...
  def update(self, sm, rr):
    ...
    if sm.updated['modelV2']:  # [pimpke] TODO: turn off radard?
      self.ready = True
    ...
    radarState.mdMonoTime = sm.logMonoTime['modelV2']  # [pimpke] TODO: check if logMonoTime is correctly set in modelV2
    ...
    # [pimpke] TODO: are leadsV3 unneeded if radard is off?
